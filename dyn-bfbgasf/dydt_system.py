...
def dydt(t, y, params, dx, x):
    ...
    drhobh2o_dt = gas.rhobh2o_rate(params, state, dx, Sh2o)
    ...
    drhobh2_dt = gas.rhobh2_rate(params, state, dx, Sh2)
    drhobch4_dt = gas.rhobch4_rate(params, state, dx, Sch4)
    drhobco_dt = gas.rhobco_rate(params, state, dx, Sco)
    drhobco2_dt = gas.rhobco2_rate(params, state, dx, Sco2)
    drhobt_dt = gas.rhobt_rate(params, state, dx, St)
